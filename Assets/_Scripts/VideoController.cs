...
public class VideoController : MonoBehaviour {
	...
	public class Video{
		...
		public void OnVideoLoaded(){
			...
			VideoController.instance.CheckIfAllVideosAreLoaded ();
		...
		public void UpdateVideoZPosition (bool isPlaying){
			...
			if (isPlaying) {
				newZPosition = VideoController.instance.playingVideoZ;
			} else {
				newZPosition = VideoController.instance.pausedVideoZ;
			}
